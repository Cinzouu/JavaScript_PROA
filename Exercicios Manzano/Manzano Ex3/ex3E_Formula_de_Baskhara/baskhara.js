function baskhara(){
    ...
    if (DELTA < 0) {
        document.getElementById("resposta").innerHTML='Não existe raiz real';
    }
    if (DELTA == 0) {
        x1 = -B/2*A;
        document.getElementById("resposta").innerHTML='O valor de X seria: '+x1;
    }
    if (DELTA>0) {
        ...
        document.getElementById("resposta").innerHTML='O valor de X1 seria ' + x1.toFixed(2)+ ' e o valor de X2 seria '+ x2.toFixed(2);
    }
